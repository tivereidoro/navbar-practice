        ...
        <>
            <div className='shadow-md w-full fixed top-0 left-0 nav-container'>
                <div className='md:flex items-center justify-between bg-white py-4 md:px-10 px-7'>
                    ...
                    <ul className={`font-[Poppins] z-40 md:flex md:items-center items-center md:pb-0 pb-8 absolute md:static bg-white md:z-40 z-[-1] left-0 w-full md:w-auto md:pl-0 transition-all duration-500 ease-in ${open ? 'top-20' : 'top-[-490px]'}`}>
                        {
                            Links.map((link) => (
